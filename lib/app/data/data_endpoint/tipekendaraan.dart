class TipeKendaraan {
  bool? status;
  String? message;
  List<DataTipe>? datatipe;

  TipeKendaraan({this.status, this.message, this.datatipe});
  ...
  TipeKendaraan.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      datatipe = <DataTipe>[];
      json['data'].forEach((v) {
        datatipe!.add(new DataTipe.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.datatipe != null) {
      data['data'] = this.datatipe!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
